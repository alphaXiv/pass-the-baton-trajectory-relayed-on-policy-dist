...
class AsyncTeacherLLMServerManager:
    ...
    async def compute_teacher_logprobs_single(
        ...
        teacher_token_logprobs = None
        if "prompt_token_logprobs" in teacher_output.extra_fields:
            teacher_token_logprobs = torch.tensor(teacher_output.extra_fields["prompt_token_logprobs"])
        return teacher_ids, teacher_logprobs, teacher_token_logprobs
