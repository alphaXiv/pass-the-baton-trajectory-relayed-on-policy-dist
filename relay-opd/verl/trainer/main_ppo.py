...
def create_rl_dataset(data_paths, data_config, tokenizer, processor, is_train=True, max_samples: int = -1):
    ...
    from verl.utils.dataset.rl_dataset import OfflineTeacherTrajectoryDataset, get_dataset_class

    # Get the dataset class
    offline_cfg = data_config.get("offline_teacher_trajectory", {})
    if is_train and offline_cfg.get("enabled", False):
        dataset_cls = OfflineTeacherTrajectoryDataset
