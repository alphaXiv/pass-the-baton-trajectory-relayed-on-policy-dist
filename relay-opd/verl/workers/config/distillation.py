...
class DistillationLossConfig(BaseConfig):
    ...
    # Relay-OPD combines student-token PG with a teacher-controlled segment.
    relay_teacher_fkl_coef: float = 1.0
    relay_action_token: str = "emitted"
    relay_teacher_mask_key: str = "relay_teacher_mask"
    relay_fallback_all_k1: bool = False
    ...
    def __post_init__(self):
        ...
        topk_distribution_losses = {
            "forward_kl_topk",
            "forward_kl_topk_teacher_renorm",
        }
        if self.use_policy_gradient and self.loss_mode in topk_distribution_losses:
            print(
