#!/usr/bin/env python3
"""Evaluate released K5 with a 1408-token response budget."""
...
WORK_DIR = Path("/tmp/relay-opd-released-m1-l4-response1408-eval512")
    ...
    env.update(
        {
            ...
            "EXP_ID": "released_trigger_relay_m1_l4_response1408_eval512",
            "TRAIN_BATCH_SIZE": "128",
            "PPO_MINI_BATCH_SIZE": "128",
            "MAX_PROMPT_LENGTH": "2048",
            "MAX_RESPONSE_LENGTH": "1408",
            "VAL_MAX_RESPONSE_LENGTH": "2048",
            "ROLLOUT_MAX_MODEL_LEN": "3457",
            "TEACHER_MAX_MODEL_LEN": "3457",
