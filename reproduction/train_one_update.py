#!/usr/bin/env python3
"""Independently replicate K5 with a 1280-token response budget."""
...
WORK_DIR = Path("/tmp/relay-opd-released-m1-l4-response1280-eval512-replica2")
    ...
    env.update(
        {
            ...
            "EXP_ID": "released_trigger_relay_m1_l4_response1280_eval512_replica2",
