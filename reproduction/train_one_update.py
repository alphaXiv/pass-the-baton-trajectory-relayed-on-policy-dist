#!/usr/bin/env python3
"""Replicate released-trigger Relay at a 1024-token training response budget."""
...
WORK_DIR = Path("/tmp/relay-opd-released-response1024-replicate")
    ...
    env.update(
        {
            ...
            "EXP_ID": "released_trigger_relay_l4_response1024_replicate",
