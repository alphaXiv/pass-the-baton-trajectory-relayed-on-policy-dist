#!/usr/bin/env python3
"""Evaluate released-trigger M1 L4 Relay at twelve optimizer updates."""
...
WORK_DIR = Path("/tmp/relay-opd-released-m1-l4-response1536-step12")
    ...
    env.update(
        {
            ...
            "EXP_ID": "released_trigger_relay_m1_l4_response1536_step12",
