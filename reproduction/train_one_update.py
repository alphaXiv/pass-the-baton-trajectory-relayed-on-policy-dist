#!/usr/bin/env python3
"""Replicate sixteen formula-correct L4 updates with repeated evaluation."""
...
WORK_DIR = Path("/tmp/relay-opd-formula-l4-sixteen-update-replicate")
    ...
    env.update(
        {
            ...
            "EXP_ID": "formula_correct_relay_l4_sixteen_update_replicate",
