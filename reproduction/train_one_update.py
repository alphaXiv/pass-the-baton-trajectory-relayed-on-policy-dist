#!/usr/bin/env python3
"""Replicate released-trigger M1 L4 Relay with repeated evaluation."""
...
WORK_DIR = Path("/tmp/relay-opd-released-m1-l4-replicate")
    ...
    env.update(
        {
            ...
            "EXP_ID": "released_trigger_relay_m1_l4_replicate",
