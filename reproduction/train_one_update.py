#!/usr/bin/env python3
"""Evaluate released-trigger M1 L3 Relay with a 1536-token training budget."""
...
WORK_DIR = Path("/tmp/relay-opd-released-m1-l3-response1536-replicate")
    ...
    env.update(
        {
            ...
            "EXP_ID": "released_trigger_relay_m1_l3_response1536_replicate",
