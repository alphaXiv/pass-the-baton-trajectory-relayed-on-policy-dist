#!/usr/bin/env python3
"""Independently replicate released K5/1024 after twelve updates."""
...
WORK_DIR = Path(
    "/tmp/relay-opd-released-m1-l4-response1024-step12-eval512-replica2"
)
...
def main() -> None:
    ...
    command = [
        ...
        "data.seed=3142",
        "actor_rollout_ref.actor.data_loader_seed=3142",
        "actor_rollout_ref.actor.fsdp_config.seed=3142",
    ]
    print(
        "TRAINING_CONFIG "
        + json.dumps(
