#!/usr/bin/env python3
"""Evaluate released-trigger K3 with a 1280-token response budget."""
...
WORK_DIR = Path("/tmp/relay-opd-released-k3-m1-l4-response1280-eval512")
    ...
    env.update(
        {
            ...
            "EXP_ID": "released_trigger_relay_k3_m1_l4_response1280_eval512",
