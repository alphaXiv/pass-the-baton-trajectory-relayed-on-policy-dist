#!/usr/bin/env python3
"""Evaluate formula-correct optimized Relay on 512 held-out problems."""
...
WORK_DIR = Path("/tmp/relay-opd-formula-m1-l4-response1536-eval512")
    ...
    env.update(
        {
            ...
            "EXP_ID": "formula_correct_relay_m1_l4_response1536_eval512",
        ...
        + json.dumps(
            {
                ...
                "method": "formula_correct_relay_opd",
            },
            sort_keys=True,
        ),
        flush=True,
