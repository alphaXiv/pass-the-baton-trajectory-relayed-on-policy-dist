#!/usr/bin/env python3
"""Evaluate released K5/1024 on 512 held-out problems."""
...
WORK_DIR = Path("/tmp/relay-opd-released-m1-l4-response1024-eval512")
    ...
    env.update(
        {
            ...
            "EXP_ID": "released_trigger_relay_m1_l4_response1024_eval512",
