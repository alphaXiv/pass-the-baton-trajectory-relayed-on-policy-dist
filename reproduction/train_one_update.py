#!/usr/bin/env python3
"""Train thirty-two Relay-OPD updates, save the actor, and evaluate it held out."""
...
WORK_DIR = Path("/tmp/relay-opd-thirty-two-update")
    ...
    env.update(
        {
            ...
            "EXP_ID": "formula_correct_relay_l4_thirty_two_update",
