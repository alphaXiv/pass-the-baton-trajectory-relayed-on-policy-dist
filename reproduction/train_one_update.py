#!/usr/bin/env python3
"""Evaluate released-trigger K10 M1 L4 Relay with a 1536-token budget."""
...
WORK_DIR = Path("/tmp/relay-opd-released-k10-m1-l4-response1536")
    ...
    env.update(
        {
            ...
            "EXP_ID": "released_trigger_relay_k10_m1_l4_response1536",
