#!/usr/bin/env python3
"""Evaluate the twenty-update half-rate Relay recipe on 512 problems."""
...
WORK_DIR = Path("/tmp/relay-opd-released-m1-l4-response1536-lr5e-7-step20-eval512")
...
def main() -> None:
    ...
    env.update(
        {
            ...
            "EXP_ID": "released_trigger_relay_m1_l4_response1536_lr5e_7_step20_eval512",
    ...
    checkpoint = output_dir / "global_step_20" / "actor" / "huggingface"
