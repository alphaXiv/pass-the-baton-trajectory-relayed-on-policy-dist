#!/usr/bin/env python3
"""Replicate sixteen released-trigger Relay updates with repeated evaluation."""
...
WORK_DIR = Path("/tmp/relay-opd-released-sixteen-update-replicate")
    ...
    env.update(
        {
            ...
            "EXP_ID": "released_trigger_relay_l4_sixteen_update_replicate",
