#!/usr/bin/env python3
"""Evaluate the half-rate Relay recipe on 512 held-out problems."""
...
WORK_DIR = Path("/tmp/relay-opd-released-m1-l4-response1536-lr5e-7-eval512")
    ...
    env.update(
        {
            ...
            "EXP_ID": "released_trigger_relay_m1_l4_response1536_lr5e_7_eval512",
