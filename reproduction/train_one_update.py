#!/usr/bin/env python3
"""Evaluate released K5/1024 after four updates."""
...
WORK_DIR = Path("/tmp/relay-opd-released-m1-l4-response1024-step4-eval512")
    ...
    env.update(
        {
            ...
            "EXP_ID": "released_trigger_relay_m1_l4_response1024_step4_eval512",
