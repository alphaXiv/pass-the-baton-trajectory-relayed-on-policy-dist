#!/usr/bin/env python3
"""Train released-trigger Relay with a 1024-token response budget."""
...
WORK_DIR = Path("/tmp/relay-opd-released-sixteen-update-response1024")
    ...
    env.update(
        {
            ...
            "EXP_ID": "released_trigger_relay_l4_sixteen_update_response1024",
